...
public class BasicModule extends InfodocModule implements Command {
	...
	public static void addJavaClasses() {
		...
		PropertyFieldFactory.getJavaClasses().add(infodoc.basic.field.SingleMyCases.class.getName());
		PropertyFieldFactory.getJavaClasses().add(infodoc.basic.field.MultipleMyCases.class.getName());
